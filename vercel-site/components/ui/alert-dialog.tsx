...
export const confirm = (opts: ConfirmOptions): Promise<boolean> => confirmImpl(opts);

export const ConfirmDialogProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  const [queue, setQueue] = React.useState<Array<ConfirmOptions & { resolve: (res: boolean) => void }>>([]);
