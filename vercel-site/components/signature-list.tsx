...
export function SignatureList({ 
  ...
  const [selectedSignature, setSelectedSignature] = useState<SignatureGenuine | SignatureForged | null>(null);
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-8">
        <div className="text-gray-500 flex items-center gap-2"><LoaderCircle className="animate-spin" /> Загрузка подписей</div>
      </div>
    );
  }
