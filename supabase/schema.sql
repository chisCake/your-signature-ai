...
-- Комбинированный код всех миграций для создания полноценной БД за раз
-- Создано на основе миграций: 000_base_schema.sql, 001_unique_id_constraint.sql, 002_input_type_stats.sql
...
-- Функция для проверки уникальности ID между таблицами
...
-- Триггеры для проверки уникальности ID между таблицами
